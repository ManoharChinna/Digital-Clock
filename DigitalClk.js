...
function clk()
{
    ...
    {
        case 0:dy="Sunday"
        bdy.style.backgroundImage="url(son.jpg)"
        break;
        case 1:dy="Monday"
        bdy.style.backgroundImage="url(mon.jpg)"
        break;
        case 2:dy="Tuesday"
        bdy.style.backgroundImage="url(tues.jpg)"
        break;
        case 3:dy="Wednesday"
        bdy.style.backgroundImage="url(wed.jpg)"
        break;
        case 4:dy="Thrusday"
        bdy.style.backgroundImage="url(thrus.jpg)"
        break;
        case 5:dy="Friday"
...
function greet()
{
    ...
    if(time>=5 && time<=12)
    {
        ...
        document.getElementById("vid").src="./Monr.mp4"
    }
